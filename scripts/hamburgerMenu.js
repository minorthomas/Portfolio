const btn = document.querySelector(".header_navbar_links_menu");
const navbar = document.querySelector(".header_navbar_links_list");
...
const hamburgerMenuLines = `
    <svg class="hamburger_svg" viewBox="0 0 18 15">
        <path fill="#424242"
